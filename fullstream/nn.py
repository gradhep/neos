...
__all__ = ['one_hot', 'simple_classifier', 'three_blob_classifier']
...
class simple_classifier:
    ...
    def plot_decision(self,plot_data=False,cmap='plasma',levels=50):
        ...
        if plot_data:
            plt.scatter(self.train_data[:,0], self.train_data[:,1],c=self.train_labels[:,0],alpha=0.2,s=1.2)
...
class three_blob_classifier():
    ...
    def __init__(self,keys=[1,2,3], nodes=5):
        ...
        k1,k2,k3 = keys
        sig  = jax.random.multivariate_normal(jax.random.PRNGKey(k1), jax.numpy.asarray([2,5]), jax.numpy.asarray([[1,0.],[0.,1]]),shape=(1,10000))[0]
        bkg1 = jax.random.multivariate_normal(jax.random.PRNGKey(k2), jax.numpy.asarray([4.5,7.5]), jax.numpy.asarray([[1,0.6],[0.6,1]]),shape=(1,5000))[0]
        bkg2 = jax.random.multivariate_normal(jax.random.PRNGKey(k3), jax.numpy.asarray([4.5,3.5]), jax.numpy.asarray([[1.7,0.2],[0.2,1]]),shape=(1,5000))[0]
