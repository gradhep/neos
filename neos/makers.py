...
__all__ = ['hists_from_nn_three_blobs', 'hists_from_nn_three_samples', 'kde_bins_from_nn_three_blobs',
           'kde_bins_from_nn_histosys', 'nn_hepdata_like', 'nn_histosys']
...
def hists_from_nn_three_samples(
    ...
    '''
    Same as hists_from_nn_three_blobs, but paramterize grouping of signal and background for
